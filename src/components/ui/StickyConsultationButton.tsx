    ...
    <div className="fixed bottom-6 right-6 z-50">
      {isExpanded ? (
        <>
          ...
          {isJobseekerPage ? (
            <a
              ...
              className="group relative bg-[var(--color-ink)] hover:bg-[var(--color-accent)] text-white px-6 py-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center space-x-3 transform hover:scale-105"
            >
              {/* Icon */}
        ...
        <button
          ...
          className="w-12 hover:cursor-pointer h-12 bg-[var(--color-ink)] hover:bg-[var(--color-accent)] text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center transform hover:scale-110"
